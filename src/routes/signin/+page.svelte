...
<div id="itdoz2" class="gjs-grid-row">
	<div id="imxmcp" class="gjs-grid-column bg-gray-700">
		<div id="irwezo" class="text-white">Welcome to the login page!<br /></div>
	</div>
</div>
<section id="i6hsp" class="gjs-section">
	<div id="is70z" class="gjs-container">
		<div class="flex items-center justify-center bg-blue-50 pb-4 pt-4">
