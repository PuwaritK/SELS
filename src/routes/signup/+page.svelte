...
<body id="i5r0m">
<div id="ilw2j-2" class="gjs-image-box"></div>
...
<section id="i6hsp-2" class="gjs-section">
	<div id="is70z-2" class="gjs-container">
		<div id="ifdk5o-2" class="gjs-grid-row">
			<div id="ivmp0j-2" class="gjs-grid-column">
				<div id="izkads-2">Username:</div>
				<div id="i63ytn">Email:</div>
				<div id="iaqogc-2">Password:</div>
				<div id="i7yb5m">Confirm Password:</div>
			</div>
			<div id="i6addv-2" class="gjs-grid-column">
				<input type="text" id="ijna4m-2" name="username" placeholder="" required/><input type="text" name="username" placeholder="" required id="ium6u3"/><input type="password" id="i3hkxo-2" name="password" required/><input type="password" name="password" required id="ivcjlh"/>
			</div>
		</div>
		<div id="ixmlac-2" class="gjs-grid-row">
			<div id="io9ldo-2" class="gjs-grid-column"><button type="submit" id="i3ovxs-2">Submit</button></div>
		</div>
	</div>
</section>
<div class="gjs-grid-row" id="ihkgv1">
	<div class="gjs-grid-column" id="ig4w4m">
		<div title="" id="if6st2">REPLACE WITH OUTPUT</div>
	</div>
</div>
</body>